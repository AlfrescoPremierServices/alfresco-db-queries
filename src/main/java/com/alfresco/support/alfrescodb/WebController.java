...
public class WebController {
    ...
    public String dbSize(Model model) {
        ...
        String tblSzSql = "SELECT table_name, pg_size_pretty(total_bytes) AS total, " +
        "row_estimate , pg_size_pretty(index_bytes) AS INDEX, pg_size_pretty(table_bytes) AS TABLE " +
